...
Over a simulated vent lifetime, the fraction of uracil in double-stranded DNA collapses from 83% to 7.2% (n=50 runs; p=0.002). This chemical selection is driven by thymine's superior hydrolytic stability and replication fidelity.Scientific Core: Chemical Darwinism
